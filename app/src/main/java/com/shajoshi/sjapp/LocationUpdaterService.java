...
public class LocationUpdaterService extends Service
{
    ...
    public static int POLL_DELAY = 12000; // 12 seconds by default
    ...
    Runnable mHandlerTask = new Runnable(){
        ...
        public void run() {
            ...
            mHandler.postDelayed(mHandlerTask, POLL_DELAY);
        }
    };
        ...
        public void onLocationChanged(Location location) {
            ...
            if (isBetterLocation(location, previousBestLocation))
            {
                ...
                try {
                    ...
                    Log.i(tag, loc);
                    MainActivity.currentLocation = previousBestLocation;
                }
                catch (Exception e)
                {
                    e.printStackTrace();
    ...
    protected boolean isBetterLocation(Location location, Location currentBestLocation) {
        ...
        boolean isSignificantlyNewer = timeDelta > POLL_DELAY;
        boolean isSignificantlyOlder = timeDelta < -POLL_DELAY;
